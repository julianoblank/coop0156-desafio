...
return [
    ...
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | Linhas de Idioma para Validações Personalizadas
    |--------------------------------------------------------------------------
    |
    ...
    | Isso agiliza a definição de uma mensagem específica para uma regra.
    |
    */

    'custom' => [
        'cpf' => [
            'digits' => 'O CPF deve conter exatamente 11 dígitos numéricos.',
        ],
    ],

    /*
    |--------------------------------------------------------------------------
    | Linhas de Idioma para Atributos Personalizados
    |--------------------------------------------------------------------------
    |
    ...
    | "email". Isso ajuda a tornar a mensagem mais expressiva.
    |
    */
